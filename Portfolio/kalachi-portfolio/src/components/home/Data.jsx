...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Hervé Talé
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Senior Lecturer</h3>
            <p className="home__description">
                Hi! I'm Hervé Talé Kalachi 😃. A senior lecturer based in Yaoundé, and i'm very passionate and dedicated to my work.
            </p>
